...
#define STRING_CONFIG_H_AUTHOR "(mattswest, ender3_creality-v4.2.7)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -8, -1.8 }
